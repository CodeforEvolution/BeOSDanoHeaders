...
class LMediaControllable : public LInterface<IMediaControllable>
{
		...
		static	BValue		hook_Control(IInterface::sptr_ref i, const BValue & v);
		static	BValue		hook_SetControl(IInterface::sptr_ref i, const BValue & v);
		static	BValue		hook_ControlInfo(IInterface::sptr_ref i, const BValue & v);
