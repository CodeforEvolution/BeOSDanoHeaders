...
public:
	...
	inline	BMediaConstraint &	Or( const BValue & key,
			...
			void				PrintToStream(ITextOutput::sptr_ref io, uint32 flags=0) const;
...
ITextOutput::sptr_ref	operator<<(ITextOutput::sptr_ref io, const BMediaConstraint & constraint);
