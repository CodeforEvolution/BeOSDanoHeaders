...
public:
	...
	static	void			MoveBefore(BAbstractOrderedVector* to, BAbstractOrderedVector* from, size_t count);
	static	void			MoveAfter(BAbstractOrderedVector* to, BAbstractOrderedVector* from, size_t count);
...
public:
	...
	static	void			MoveBefore(BOrderedVector<TYPE>& to, BOrderedVector<TYPE>& from, size_t count);
	static	void			MoveAfter(BOrderedVector<TYPE>& to, BOrderedVector<TYPE>& from, size_t count);
...
inline void BMoveBefore(BAbstractOrderedVector* to, BAbstractOrderedVector* from, size_t count)
{
	BAbstractOrderedVector::MoveBefore(to, from, count);
}

inline void BMoveAfter(BAbstractOrderedVector* to, BAbstractOrderedVector* from, size_t count)
{
	BAbstractOrderedVector::MoveAfter(to, from, count);
}
...
template<class TYPE>
void BOrderedVector<TYPE>::PerformReplicate(void* to, const void* protoElement, size_t count) const
{
