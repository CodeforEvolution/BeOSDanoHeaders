...
public:
	...
	static	void			MoveBefore(BAbstractVector* to, BAbstractVector* from, size_t count);
	static	void			MoveAfter(BAbstractVector* to, BAbstractVector* from, size_t count);
...
public:
	...
	static	void			MoveBefore(BVector<TYPE>& to, BVector<TYPE>& from, size_t count);
	static	void			MoveAfter(BVector<TYPE>& to, BVector<TYPE>& from, size_t count);
...
inline void BMoveBefore(BAbstractVector* to, BAbstractVector* from, size_t count)
{
	BAbstractVector::MoveBefore(to, from, count);
}

inline void BMoveAfter(BAbstractVector* to, BAbstractVector* from, size_t count)
{
	BAbstractVector::MoveAfter(to, from, count);
}
...
template<class TYPE> inline
status_t BVector<TYPE>::SetSize(size_t total_count)
{
	return BAbstractVector::SetSize(total_count, NULL);
}

template<class TYPE> inline
status_t BVector<TYPE>::SetSize(size_t total_count, const TYPE& protoElement)
{
	return BAbstractVector::SetSize(total_count, &protoElement);
}
...
template<class TYPE>
void BVector<TYPE>::PerformReplicate(void *to, const void* protoElement, size_t count) const
{
